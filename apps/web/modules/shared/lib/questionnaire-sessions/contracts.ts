...
export type QuestionnaireSessionsRepository = {
  ...
  start(input: CommandIdentity & { organizationId: string; questionnaireVersionId: string; locale: "fr" | "ar"; dueAt: string | null; siteId?: string | null }): Promise<QuestionnaireResult<{ sessionId: string; rowVersion: number }>>;
