...
const fr = {
  ...
  organization:"Organisation cliente", companySite:"Site de l’entreprise", noCompanySite:"Aucun site enregistré — créez-le dans le portefeuille.", libraryId:"Bibliothèque", serviceId:"Service", questionnaireId:"Version du questionnaire", catalogHash:"Empreinte du catalogue", questionnaireHash:"Empreinte du questionnaire",
  ...
  select:"Sélectionner ce devis", seeOffer:"Voir le détail de l’offre", expiredQuote:"Ce devis a expiré et ne peut plus être sélectionné.", selected:"Devis sélectionné. Le contrat reprendra cette version immuable.",
  actionError:"L’opération n’a pas abouti. Actualisez les données avant de réessayer.", privacy:"Chaque prestataire ne voit que sa propre invitation et sa propre offre. Les coordonnées restent masquées avant la sélection.",
  completeness:"Complétude du devis", incompleteQuote:"Ce devis n’est pas complet et ne peut pas être sélectionné.",
  selectionReason:"Motif de sélection", confirmSelection:"Je confirme le choix de cette offre. Les autres prestataires recevront un retour anonymisé.",
  contactsHidden:"Les coordonnées du prestataire restent masquées. Les échanges passent par la messagerie Matricia.",
  demoSelectionDisabled:"Ces colonnes illustrent une comparaison. La sélection réelle n’est possible que sur des devis soumis.",
  selecting:"Enregistrement du choix…",
  trialExpiredBlock:"L’essai de 30 jours est terminé. L’historique est conservé. Une offre Gold réactive l’ouverture de nouvelles consultations.",
  expiredDocumentBlock:"Un document de conformité est expiré. La mission en cours n’est pas interrompue. Mettez-le à jour avant d’ouvrir une nouvelle consultation.",
  notEntitled:"Nouvelle consultation impossible : essai ou abonnement inactif, ou document de conformité expiré. L’historique est conservé.",
  reactivateGold:"Réactiver avec Gold",
...
const ar = {
  ...
  organization:"المنظمة العميلة", companySite:"موقع المؤسسة", noCompanySite:"لا يوجد موقع مسجّل — أنشئه في المحفظة.", libraryId:"المكتبة", serviceId:"الخدمة", questionnaireId:"نسخة الاستبيان", catalogHash:"بصمة الكتالوج", questionnaireHash:"بصمة الاستبيان",
  ...
  select:"اختيار هذا العرض", seeOffer:"عرض تفاصيل العرض", expiredQuote:"انتهت صلاحية هذا العرض ولا يمكن اختياره.", selected:"تم اختيار العرض وستعتمد العقود هذه النسخة غير القابلة للتغيير.",
  actionError:"لم تنجح العملية. حدّث البيانات ثم أعد المحاولة.", privacy:"كل مقدم خدمة يرى دعوته وعرضه فقط. تبقى بيانات الاتصال مخفية قبل الاختيار.",
  completeness:"اكتمال العرض", incompleteQuote:"هذا العرض غير مكتمل ولا يمكن اختياره.",
  selectionReason:"سبب الاختيار", confirmSelection:"أؤكد اختيار هذا العرض. سيتلقى مقدمو الخدمات الآخرون ملاحظاً مجهول الهوية.",
  contactsHidden:"تبقى بيانات اتصال مقدم الخدمة مخفية. تمرّ التبادلات عبر مراسلة ماتريسيا.",
  demoSelectionDisabled:"هذه الأعمدة توضح مقارنة. الاختيار الفعلي ممكن فقط على عروض مقدَّمة.",
  selecting:"جارٍ حفظ الاختيار…",
  trialExpiredBlock:"انتهت تجربة الثلاثين يوماً. يُحتفظ بالسجل. تعيد عرض Gold فتح استشارات جديدة.",
  expiredDocumentBlock:"وثيقة امتثال منتهية. المهمة الجارية لا تُقطع. حدّثها قبل فتح استشارة جديدة.",
  notEntitled:"تعذر فتح استشارة جديدة: التجربة أو الاشتراك غير نشط، أو وثيقة امتثال منتهية. يُحتفظ بالسجل.",
  reactivateGold:"إعادة التفعيل بعرض Gold",
