...
vi.mock("@/modules/shared/ui/card", () => ({ Card: (p: ComponentPropsWithoutRef<"div">) => <div {...p}/>, CardContent: (p: ComponentPropsWithoutRef<"div">) => <div {...p}/>, CardHeader: (p: ComponentPropsWithoutRef<"div">) => <div {...p}/>, CardTitle: (p: ComponentPropsWithoutRef<"h2">) => <h2 {...p}/> }));
