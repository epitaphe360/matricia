...
vi.mock("@/modules/shared/lib/rule-validation/model", async () => await import("@/modules/shared/lib/rule-validation/model"));
vi.mock("@/modules/shared/lib/rule-validation/server-repository", () => ({ createServerRuleValidationRepository: async () => ({ validate: mocks.validate, simulate: mocks.simulate }) }));
