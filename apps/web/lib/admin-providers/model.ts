...
export type AdminProviderInvoice = { id: string; providerOrganizationId: string; providerName: string; statementId: string; number: string; currency: string; totalMinor: string; paidMinor: string; outstandingMinor: string; paymentStatus: string; dueOn: string };
...
export type AdminProviderDashboard = { capabilities: { qualificationDecision: boolean; financeAction: boolean; readOnly: boolean }; providers: AdminProvider[]; services: AdminProviderService[]; documents: AdminProviderDocument[]; statements: AdminProviderStatement[]; invoices: AdminProviderInvoice[]; payments: AdminProviderPayment[]; accounts: AdminProviderAccount[]; totalsByCurrency: Array<{ currency: string; invoicedMinor: string; outstandingMinor: string; receivedMinor: string; unallocatedMinor: string }>; limitsReached: string[] };
