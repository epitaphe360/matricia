...
const fr = {
  ...
  createTitle:"Créer une demande", createDescription:"Les identifiants et empreintes proviennent du catalogue publié sélectionné. Les montants sont saisis en MAD, sans calcul flottant.",
  ...
  need:"Besoin détaillé", urgency:"Urgence", desiredDate:"Date souhaitée", budgetAmount:"Budget MAD", region:"Région", reason:"Motif de création", confirm:"Je confirme l’exactitude de la demande",
  create:"Enregistrer la demande", creating:"Enregistrement…", validation:"Vérifiez tous les champs et les empreintes.", saved:"Demande enregistrée.", detailTitle:"Détail de la demande",
...
const ar = {
  ...
  createTitle:"إنشاء طلب", createDescription:"تأتي المعرفات والبصمات من الكتالوج المنشور. تُدخل المبالغ بالدرهم دون أعداد عائمة.",
  ...
  need:"وصف الحاجة", urgency:"الاستعجال", desiredDate:"التاريخ المطلوب", budgetAmount:"الميزانية بالدرهم", region:"المنطقة", reason:"سبب الإنشاء", confirm:"أؤكد صحة الطلب",
  create:"حفظ الطلب", creating:"جارٍ الحفظ…", validation:"تحقق من جميع الحقول والبصمات.", saved:"تم حفظ الطلب.", detailTitle:"تفاصيل الطلب",
...
export type ClientRfqMessages = { [K in Exclude<keyof typeof fr,"statuses">]:string } & { statuses:Record<keyof typeof fr.statuses,string> };
