...
describe("client analysis form", () => {
  it("does not expose a session or service identifier", () => {
    const html = renderToStaticMarkup(<CompleteForm locale="fr" organizations={[{ id: "11111111-1111-4111-8111-111111111111", name: "Entreprise A", latestAt: "2026-09-15T12:00:00Z" }]} m={messages("fr")} keyValue="44444444-4444-4444-8444-444444444444" />);
  ...
  it("renders an honest empty state without an inactive form action", () => {
    const html = renderToStaticMarkup(<CompleteForm locale="ar" organizations={[]} m={messages("ar")} keyValue="44444444-4444-4444-8444-444444444444" />);
    expect(html).toContain("لا يوجد تقييم مكتمل");
    expect(html).not.toContain("<button");
  });

  it("asks for a named organization when several authorized contexts exist", () => {
    const html = renderToStaticMarkup(<CompleteForm locale="fr" organizations={[{ id: "11111111-1111-4111-8111-111111111111", name: "Entreprise A", latestAt: "2026-09-15T12:00:00Z" }, { id: "22222222-2222-4222-8222-222222222222", name: "Entreprise B", latestAt: "2026-09-14T12:00:00Z" }]} m={messages("fr")} keyValue="44444444-4444-4444-8444-444444444444" />);
