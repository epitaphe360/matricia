...
vi.mock("@/lib/solution-insights/server-repository", () => ({ createServerSolutionInsightsRepository: async () => ({ decide: mocks.decide }) }));
vi.mock("@/lib/solution-insights/model", async () => await import("../../../../../lib/solution-insights/model"));
