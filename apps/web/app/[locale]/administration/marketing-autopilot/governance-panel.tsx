...
export function GovernancePanel({ dashboard, data, locale, keys }: { dashboard: MarketingDashboard; data: MarketingGovernance; locale: "fr" | "ar"; keys: Record<string, string> }) {
  ...
  return <section aria-labelledby="marketing-governance" className="rounded-2xl border bg-card p-4 sm:p-6">
    ...
    <div className="mt-5 grid gap-5 xl:grid-cols-3">
      ...
      <form action={securityAction} className="grid content-start gap-3">
