...
vi.mock("@/components/ui/alert", () => ({ Alert: ({ children, ...props }: { children: ReactNode } & ComponentPropsWithoutRef<"div">) => <div {...props}>{children}</div>, AlertDescription: ({ children }: { children: ReactNode }) => <div>{children}</div> }));
