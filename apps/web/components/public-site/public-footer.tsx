    ...
    <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:grid-cols-[1fr_auto] sm:px-6">
      ...
      <nav aria-label={copy.footerLabel}>
        <ul className="grid grid-cols-2 gap-x-5 gap-y-1 text-sm sm:grid-cols-1">
          <li><Link className="inline-flex min-h-11 items-center rounded-md underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" href={`/${locale}/diagnostic`}>{copy.services}</Link></li>
