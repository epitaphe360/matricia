...
select extensions.throws_ok($$select public.record_marketing_brand_authorization_v41('13510000-0000-4000-8000-000000000001','GRANTED',array['SOCIAL_PUBLISHING'],'P135-AAL2',repeat('9',64),clock_timestamp(),null,'p135-brand-aal1')$$,'42501'::char(5));
