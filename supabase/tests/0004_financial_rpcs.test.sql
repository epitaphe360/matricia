...
select public.post_financial_journal(
  'd0000000-0000-0000-0000-000000000004','journal-key-0001',repeat('a',64),'SALE','MAD',now(),'RPC test',
  jsonb_build_array(
...
select public.append_credit_entry('d0000000-0000-0000-0000-000000000004','d4000000-0000-0000-0000-000000000004','GRANT',25,'TEST','credit-1','credit-key-0001',repeat('b',64),'d6000000-0000-0000-0000-000000000006');
select public.append_credit_entry('d0000000-0000-0000-0000-000000000004','d4000000-0000-0000-0000-000000000004','GRANT',25,'TEST','credit-1','credit-key-0001',repeat('b',64),'d6000000-0000-0000-0000-000000000006');
...
select throws_ok(
  $$insert into public.credit_ledger_entries (organization_id,wallet_id,entry_type,quantity,idempotency_scope,idempotency_key,correlation_id,reference_type,reference_id,created_by) values ('d0000000-0000-0000-0000-000000000004','d4000000-0000-0000-0000-000000000004','GRANT',1,'direct.write','direct-key-0001','d8000000-0000-0000-0000-000000000008','TEST','direct','50000000-0000-0000-0000-000000000005')$$,
  '42501','permission denied for table credit_ledger_entries','authenticated users cannot write a ledger directly'
);
reset role;
